...
STATIC_ASSERT(_prio < CONFIG_NRF_SDH_REQ_OBSERVER_PRIO_LEVELS, "Priority level unavailable.");     \
...
STATIC_ASSERT(_prio < CONFIG_NRF_SDH_STATE_OBSERVER_PRIO_LEVELS, "Priority level unavailable.");\
/*lint -esym(528,*_observer) -esym(529,*_observer) : Symbol not referenced. */                  \
NRF_SECTION_SET_ITEM_REGISTER(sdh_state_observers, _prio, \
		nrf_sdh_state_observer_t const, _observer)
...
STATIC_ASSERT(_prio < CONFIG_NRF_SDH_STACK_OBSERVER_PRIO_LEVELS, "Priority level unavailable.");                 \
/*lint -esym(528,*_observer) -esym(529,*_observer) : Symbol not referenced. */                            \
NRF_SECTION_SET_ITEM_REGISTER(sdh_stack_observers, _prio, const nrf_sdh_stack_observer_t, _observer)
